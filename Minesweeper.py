# Rozpoczęty: 23.07.2020 21:45 #

# 09.09.2020 23:06 - to kurwa działa. W koncu #
# od dobrych kilku dni meczylem sie, zeby napisac gowniany algorytm ktory sam odslania pola#
# ciezko bylo wymyslic jak je automatycznie kliknac#
# jeszcze po drodze pojebalem wspolrzędne X z Y ..........#
# teraz zostalo dodac zaznaczanie flag prawym przyciskiem myszy#
# dalej bedziemy myslec, pozdro memek #
# @@EDIT 09.09.2020 23:34 - znalazlem pare bugów: mianowicie powinno odsłaniać pola po skosie, a wcale tego nie robi #

# @@EDIT 10.09.2020 18:35 - po skosie dziala ##

# @@EDIT 06.10.2020 18.34 - po długim czasie nic nie robienia dodałem msg boxy i funkcję restart :) #
# PROJEKT OFICJALNIE ZAKOŃCZONY Z DATĄ 06.10.2020 18.34 #
# MOŻNA DODAĆ JESZCZE KILKA FUNKCONALNOŚCI ALE TO MOŻE KIEDY INDZIEJ, BIERE SIE ZA JS - REACT #
# pozdro memek #
